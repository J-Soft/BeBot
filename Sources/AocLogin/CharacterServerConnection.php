...
class CharacterServerConnection extends ServerConnection
{
    ...
    public function CharacterServerConnection(
      ...
      $loginType
        ...
        parent::ServerConnection("Conan Char Server ", $serverAddress, $serverPort, $clientEndpoint, $serverEndpoint,
          $loginType);
        ...
        do {
            ...
            switch ($rpcID) {
                ...
                case RPC_TERRITORY_ERROR: {
                    trigger_error("RPC_UNIVERSE_ERROR: Error while authenticating to territory [Err:" . $this->displayConanError($packet->args[0]) . "]",
                      E_USER_WARNING);
                    return false;
                }
