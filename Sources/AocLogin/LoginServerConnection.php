...
class LoginServerConnection extends ServerConnection
{
    ...
    public function LoginServerConnection(
      ...
      $loginType
        ...
        parent::ServerConnection("Conan Login Server", $serverAddress, $serverPort, $clientEndpoint, $serverEndpoint,
          $loginType);
    ...
    public function HandlePackets()
    {
        do {
            ...
            switch ($rpcID) {
                ...
                case -1:
                    trigger_error("RPC_LOGINSERVER_ERROR: Error while reading message header [Err:Unknown RPC ID]",
                      E_USER_WARNING);
                    return false;
