    ...
    function raffle_join($name)
    {
        if (empty($this->item)) {
            ...
            if (isset($this->users[$name])) {
                ...
                $this->output("##raffle_highlight##" . $name . "##end## has ##raffle_highlight##joined##end##" . " the raffle ::" . $this->click_join("join"),
                  1);
            }
        }
    }
    ...
    function raffle_leave($name)
    {
        if (!isset($this->item)) {
            ...
            if (!isset($this->users[$name])) {
                ...
                $this->output("##raffle_highlight##" . $name . "##end## has ##raffle_highlight##left##end##" . " the raffle :: " . $this->click_join("join"),
                  1);
            }
        }
    }
