        ...
        foreach ($lines as $line) {
            ...
            if ($is_rare) {
                if ($rarity == 2 || $rarity == 1) {
                    ...
                    $text .= $this->renderLink($prefix, "Cabochon", $gem, "Arm",
                        $cut_arm) . " ##gemcut_highlight##:##end## ";
                ...
                if ($rarity == 2 || $rarity == 0) {
                    ...
                    $text .= $this->renderLink($prefix, "Oblique", $gem, "Arm",
                        $cut_arm) . " ##gemcut_highlight##:##end## ";
                    $text .= "##gemcut_info##(##end##$effect##gemcut_info##)##end##\n";
                }
            }
        ...
        if (preg_match("/[1-6]/", $msg)) {
            ...
            for ($i = 0; $i < count($this->tier_info); $i++) {
                $txt .= $this->bot->core("tools")
                    ->chatcmd("gems " . ($i + 1),
                      "Tier " . ($i + 1) . " gems") . " : Level " . $this->tier_info[$i][0] . " - Drops in: " . $this->tier_info[$i][1] . ".\n";
            }
