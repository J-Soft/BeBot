...
More documentation at https://bebotwiki.000webhostapp.com/index.php/Main_Page
...
* Now run StartBot (.php under linux or .bat under windows) :
 - Windows: Navigate to the directory of your bot assuming you have the
   php.exe in the same directory and write "StartBot.bat".
 - Linux: Assuming your can run php from anywhere navigate to your bot 
   directory and write e.g. "php StartBot.php" (assuming your php binary is 
   named "php" in this example).
