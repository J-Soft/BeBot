...
class Notify extends BaseActiveModule
{
  ...
  function show_notify_list()
  {
    ...
    return $total . " Characters on notify: " . $this->bot->core("tools")->make_blob($membercount . " Member", $member) . ", " . $this->bot->core("tools")->make_blob($guestcount . " Guests", $guest) . ", " . $this->bot->core("tools")->make_blob($othercount . " Others", $other);
  }
