...
class Raffle extends BaseActiveModule
{
    ...
    {
        if (!empty($this->item) && (($this->admin == $name) || $this->bot->core("security")->check_access($name, "admin"))) {
    ...
    function make_admin($name)
    {
        ...
        else
        {
            ...
            $inside .= $this->bot->core("tools")->chatcmd("raffle output guild", "Guild") . " ";
            $inside .= $this->bot->core("tools")->chatcmd("raffle output group", "Group") . " ";
            $inside .= $this->bot->core("tools")->chatcmd("raffle output both", "Both") . "\n\n";
            $inside .= "Item: " . $this->item_blank . "\n\n";
            $inside .= "- " . $this->bot->core("tools")->chatcmd("raffle join", "Join the raffle") . "\n";
            $inside .= "- " . $this->bot->core("tools")->chatcmd("raffle leave", "Leave the raffle") . "\n\n";
            $inside .= "Cancel raffle: " . $this->bot->core("tools")->chatcmd("raffle cancel", "click") . "\n\n";
            $inside .= "Announce raffle still open: " . $this->bot->core("tools")->chatcmd("raffle reannounce", "click") . "\n\n";
            $inside .= "Announce raffle closing soon: " . $this->bot->core("tools")->chatcmd("raffle closing", "click") . "\n\n";
            $inside .= ":: " . $this->bot->core("tools")->chatcmd("raffle result", "Show winner!") . " ::\n";
