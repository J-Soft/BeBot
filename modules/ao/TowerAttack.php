...
class TowerAttack extends BaseActiveModule
{
    ...
    function update_table()
    {
        ...
        case 1:
            ...
            $this->bot->db->query(
                "CREATE TABLE IF NOT EXISTS " . $tablename . "(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, " . "time int, " . "off_guild VARCHAR(50), "
                    . "off_side VARCHAR(10), "
                    . "off_player VARCHAR(20), " . "off_level int, " . "off_profession VARCHAR(15), " . "def_guild VARCHAR(50), " . "def_side VARCHAR(10), "
                    . "zone VARCHAR(50), "
                    . "x_coord INT, " . "y_coord INT, " . "UNIQUE (time, off_guild, off_side, off_player, def_guild, def_side, zone, x_coord, y_coord), "
                    . "INDEX (off_guild), "
